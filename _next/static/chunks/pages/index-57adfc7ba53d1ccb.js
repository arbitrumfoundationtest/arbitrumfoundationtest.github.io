(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[5405], {
		...
		58131: function(a, b, c) {
			...
			function t() {
				...
				return (0, d.jsx)(l(), {
					...
					children: s.map(function(a, e) {
						return (0, d.jsxs)("div", {
							className: "[ c-Carousel__slide ] [ flickity-slide ]",
							children: [(0, d.jsx)("div", {
								className: "c-Carousel__slide-graphic",
								children: (0, d.jsx)(o.Z, {
									imageObj: {
										sizes: ["/illustration_3-".concat(e + 1, ".webp")],
										alt: "Illustration 3",
										width: 830,
										height: 830
									}
								...
								className: "c-Carousel__slide-content",
								children: [(0, d.jsxs)("ul", {
									className: "c-Carousel__slide-content-labels",
									...
									className: "c-Carousel__slide-content-actions",
									children: [(0, d.jsxs)(d.Fragment, {
										children: [(0, d.jsx)("button", {
											className: "c-Carousel__arrow",
											onClick: b,
											"aria-label": "prev"
										}), (0, d.jsx)("button", {
											className: "c-Carousel__arrow",
			...
			var u = c(82508),
				v = [{
					...
					text: (0, d.jsxs)(d.Fragment, {
						children: ["This set of validators has been expanded to include", " ", (0, d.jsx)(u.d, {
							className: "underline",
					...
					lede: (0, d.jsxs)(d.Fragment, {
						children: ["Arbitrum Nova has a 7-party DAC, whose members can be seen", " ", (0, d.jsx)(u.d, {
					...
					f = (0, p.useMemo)(function() {
						return v.map(function(a, c) {
							return (0, d.jsxs)("div", {
								...
								className: "c-HorizontalAccordion__tab ".concat(b === c ? "is-active" : ""),
								children: [(0, d.jsx)("div", {
									className: "c-HorizontalAccordion__tab-label only-desktop",
			...
			function z() {
				...
				return (0, p.useEffect)(function() {
					if (null === (b = a.current) || void 0 === b ? void 0 : b.children) {
						var b, c = new IntersectionObserver(y, {
							rootMargin: "0% 0% -30% 0%",
							threshold: 1
						});
			...
			function E(a) {
				...
				return (0, p.useEffect)(function() {
					c.current && !A.tq && new IntersectionObserver(e, D).observe(c.current)
				}, [c]), (0, d.jsx)("div", {
					ref: c,
					children: (0, d.jsxs)(l(), {
						elementType: "div",
							...
							children: (0, d.jsxs)("div", {
								...
								children: [(0, d.jsxs)("div", {
									children: [(0, d.jsx)("div", {
										...
										children: "Delegates are users who are committed to being consistently involved in governance"
									}), (0, d.jsx)("p", {
										children: "Token holders will be able to select a preferred delegate, including themselves, and can re-delegate at any time."
									})]
								}), b ? (0, d.jsx)(u.d, {
							...
							children: (0, d.jsxs)("div", {
								...
								children: [(0, d.jsxs)("div", {
									children: [(0, d.jsx)("div", {
										...
										className: "c-FeatureCard__heading",
										children: "The Security Council can approve protocol upgrades when a fast response is needed"
									}), (0, d.jsx)("p", {
										children: "The Security Council is composed of 12 highly reputable members of the community. Emergency upgrades require a 9-of-12 multisig."
									})]
								}), (0, d.jsx)(u.d, {
							...
							children: (0, d.jsxs)("div", {
								...
								children: [(0, d.jsxs)("div", {
									children: [(0, d.jsx)("div", {
										...
										children: "The Arbitrum DAO includes token holders and their delegates. It has the power to upgrade the protocol and constitution, as well as elect the Security Council. Proposals for upgrades and amendments are submitted and voted on by the DAO."
									})]
								}), (0, d.jsx)(u.d, {
				...
				H = f()(function() {
					...
					loading: function() {
						return (0, d.jsxs)("button", {
							className: "c-ConnectButton interact-button",
				...
				return (0, d.jsxs)(d.Fragment, {
					children: [(0, d.jsxs)(h(), {
						children: [(0, d.jsx)("title", {
							children: "Arbitrum — Check your airdrop eligibility to govern Arbitrum"
						}), (0, d.jsx)("meta", {
							name: "description",
							content: "Discover if you are eligible to receive the Arbitrum airdrop, claim your tokens, and delegate your voting power"
						}), (0, d.jsx)("meta", {
							name: "viewport",
						...
						className: "home",
						children: [(0, d.jsx)(m.h4, {}), (0, d.jsx)("section", {
							...
							className: "[ l-Section l-Section--adjacent-image-text-card ] [ has-sticky ]",
							children: [(0, d.jsxs)("div", {
								...
								children: [(0, d.jsx)("h3", {
									...
									children: ["The Arbitrum DAO is a massive leap forward, making Arbitrum the first EVM rollup tech to reach", " ", (0, d.jsx)(u.d, {
							...
							children: (0, d.jsxs)("div", {
								className: "l-Section__card !bg-[rgba(38,40,42,0.8)] md:!backdrop-blur-[3px] w-full max-w-[1150px] m-auto flex-col-reverse md:flex-row flex items-center justify-center",
								children: [(0, d.jsxs)("div", {
									...
									children: [(0, d.jsx)("span", {
										...
										className: "c-FeatureCard__heading mt-6 !mb-6 max-w-[440px]",
										children: "Starting today, anyone can easily launch a new Arbitrum chain as a Layer 3 in the Arbitrum ecosystem."
									}), (0, d.jsx)(j(), {
										href: "/orbit",
										legacyBehavior: !0,
										children: (0, d.jsx)("a", {
							...
							children: [(0, d.jsxs)("div", {
								...
								children: [(0, d.jsx)("h2", {
									...
									children: "Individuals across the ecosystem can participate in governance. Token holders control protocol upgrades, funds allocation, and election of a Security Council who can perform emergency upgrades. Your voting power is derived directly from the number of tokens delegated to you."
								}), (0, d.jsx)(q.Z, {})]
							}), (0, d.jsx)("div", {
								className: "[ l-Section__3up-cards l-Section--collapse-to-carousel ]",
								children: (0, d.jsx)("div", {
						...
						}), (0, d.jsx)("hr", {}), (0, d.jsxs)("section", {
							className: "[ l-Section l-Section--cta-blocks l-Section--collapse-to-carousel ]",
							children: [(0, d.jsx)("div", {
								className: "l-Section--cta-blocks__intro",
								children: (0, d.jsx)("h2", {
									className: "l-Section__heading",
								...
								children: (0, d.jsxs)(l(), {
									...
									children: [(0, d.jsx)("div", {
										...
										children: (0, d.jsxs)(u.d, {
											...
											children: [(0, d.jsx)("span", {
												className: "[ c-CTABlock__label ] [ c-Label c-Label--dark ]",
												children: "Visit the Forum"
											}), (0, d.jsx)("h4", {
												className: "c-CTABlock__heading",
												children: "View or submit delegate applications"
											}), (0, d.jsx)("div", {
										...
										children: (0, d.jsxs)(u.d, {
											...
											children: [(0, d.jsx)("span", {
												...
												className: "c-CTABlock__heading",
												children: "See projects in the Arbitrum universe"
											}), (0, d.jsx)("div", {
												className: "c-CTABlock__image",
												children: (0, d.jsx)(o.Z, {
													imageObj: L
		...
		28396: function(a, b, c) {
			...
			function g(a) {
				...
				return (0, d.jsxs)(f.d, {
					...
					className: "c-Button c-Button--icon ".concat(void 0 !== b && b ? "c-Button--outline" : "c-Button--blue"),
	...
	function(a) {
		a.O(0, [395, 5149, 7083, 9460, 1787, 9721, 5186, 6275, 9774, 2888, 179], function() {
			var b;
			return a(a.s = 48312)
		}), _N_E = a.O()
	}
